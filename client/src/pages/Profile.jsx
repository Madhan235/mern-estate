...
//eslint-disable-next-line
  ...
  const hanldeListingDelete = async(listingId) => {
   try {
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      {userListings.map((listing)=>(
        ...
        <Link to={`/listing/${listing._id}`}>
          <img src={listing.imageUrls[0]} alt="listing cover" className="h-16 w-16 object-contain rounded-2xl " />
        ...
        <div className="flex flex-col items-center ">
         <button onClick={()=>hanldeListingDelete(listing._id)} className="text-red-700 uppercase">Delete</button>
